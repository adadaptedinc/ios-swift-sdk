#
#  Be sure to run `pod spec lint AASwiftSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Brett Clifton"
  # spec.authors            = { "Brett Clifton" => "bclifton@adadapted.com" }
  # spec.social_media_url   = "https://twitter.com/Brett Clifton"
